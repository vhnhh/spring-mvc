...
<div class="container">
    ...
    <c:forEach items="${list}" var="song">
        <div class="card w-100 my-3">
            <img src="${song.imgUrl}" class="card-img-top rounded mx-auto d-block" alt="...">
            <div class="card-body">
                <p class="text-break fw-lighter fst-italic text-end"><small>
                    ${song.id} - ${song.duration} - ${song.status}
                </small></p>
                <h5 class="card-title">${song.name}</h5>
                <p class="card-text">${song.description}</p>
                <span class="border-start border-4 border-primary ps-1 text-secondary">${song.author}</span>
