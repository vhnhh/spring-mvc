...
<body>
<form action="<%=request.getContextPath()%>/update?id=${post.id}" method="post">
    ...
    <div class="modal-body">
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="" aria-label="title"
                   aria-describedby="title" name="title" value="${post.title}" required>
        </div>
        <div class="input-group mb-3">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="" aria-label="author"
                   aria-describedby="author" name="author" value="${post.author}" required>
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text" id="imgUrl">Image Url</span>
            <input type="text" class="form-control" placeholder="" aria-label="imgUrl"
                   aria-describedby="imgUrl" name="imgUrl" value="${post.imgUrl}" required>
        </div>
    </div>
